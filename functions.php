...
function myfirsttheme_register_scripts() {
  wp_enqueue_script('myfirsttheme-script', 
    get_template_directory_uri()."/assets/js/main.js",
    array(), 
    '1.0',
    true
  );
  wp_enqueue_script('myfirsttheme-bootstrap', 
    "https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js", 
    array(), 
    '4.4.1',
    true
  );
  wp_enqueue_script('myfirsttheme-jquery', 
    "https://code.jquery.com/jquery-3.4.1.slim.min.js", 
    array(), 
    '3.4.1',
    true
  );
  wp_enqueue_script('myfirsttheme-popper', 
...
add_action('wp_enqueue_scripts', 'myfirsttheme_register_scripts');

function myfirsttheme_widget_areas() {
  register_sidebar(
    array(
      'before_title' => '',
      'after_title' => '',
...
add_action('widgets_init', 'myfirsttheme_widget_areas');
